...
class QueryAnalyzer:
    def __init__(self):
        ...
        # Keywords suggesting simplicity
    ...
    def analyze_query(self, query: str) -> QueryAnalysisResult:
        ...
        # Determine needs based on complexity
    ...
    def _calculate_dependency_depth(self, doc) -> float:
        """Calculate syntactic complexity using dependency tree depth."""
        max_depth = 0
        for token in doc:
            depth = 1
            current = token
        ...
        return max_depth / 5  # Normalize by typical max depth

    def _calculate_keyword_complexity(self, query: str) -> float:
        """Calculate complexity based on presence of indicator words."""
        score = 1.0
    ...
    def _analyze_question_type(self, query: str) -> float:
        """Analyze the type and complexity of the question."""
        lower_query = query.lower()
    ...
    def _generate_explanation(self, features: Dict[str, float], complexity_score: float) -> List[str]:
        ...
        # Keyword complexity explanation
